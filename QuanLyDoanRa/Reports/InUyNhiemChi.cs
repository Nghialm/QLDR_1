...
{
    public partial class InUyNhiemChi : DevExpress.XtraReports.UI.XtraReport
    {
        public InUyNhiemChi()
        {
            InitializeComponent();
        ...
        public InUyNhiemChi(VnsChungTu p_objChungTu,VnsDmKhachHang p_KhachHang, IList<VnsGiaoDich> p_lstGiaoDich, Decimal p_SoTien, DateTime p_NgayCt)
        {
            InitializeComponent();
