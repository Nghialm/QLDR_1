...
{
    public partial class ChungTuGhiSo : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public ChungTuGhiSo(DateTime p_TuNgay, DateTime p_DenNgay, string p_TkCo, string p_TkNo, string p_TrangThaiCt, int giaTri, string TimeTitle)
        {
            InitializeComponent();
        ...
        {
            ChungTuGhiSoHeader p1 = (ChungTuGhiSoHeader)((XRSubreport)sender).ReportSource;
        ...
        {
            ChungTuGhiSoDetail p2 = (ChungTuGhiSoDetail)((XRSubreport)sender).ReportSource;
