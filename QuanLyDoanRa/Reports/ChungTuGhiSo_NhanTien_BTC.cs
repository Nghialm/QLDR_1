...
{
    public partial class ChungTuGhiSo_NhanTien_BTC : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public ChungTuGhiSo_NhanTien_BTC()
        {
            InitializeComponent();
        }
        public ChungTuGhiSo_NhanTien_BTC(DateTime p_TuNgay, DateTime p_DenNgay, string p_TkCo, string p_TkNo, string p_TrangThaiCt, int giaTri, string TimeTitle)
        {
            InitializeComponent();
        ...
        {
            ChungTuGhiSoHeader_NhanTien_BTC p1 = (ChungTuGhiSoHeader_NhanTien_BTC)((XRSubreport)sender).ReportSource;
        ...
        {
            ChungTuGhiSoDetail_NhanTien_BTC p2 = (ChungTuGhiSoDetail_NhanTien_BTC)((XRSubreport)sender).ReportSource;
