...
{
    public partial class SoChiTietTK_VND : DevExpress.XtraReports.UI.XtraReport
    {
        public SoChiTietTK_VND()
        {
            InitializeComponent();
        }
        ...
        public SoChiTietTK_VND(DateTime p_TuNgay, DateTime p_DenNgay,String Time, string MaTk, string MaTkDu)
        {
            InitializeComponent();
            m_TuNgay = p_TuNgay;
            m_DenNgay = p_DenNgay;
        ...
        {
            SoChiTietTK_VND_P1 p1 = (SoChiTietTK_VND_P1)((XRSubreport)sender).ReportSource;
        ...
        {
            SoChiTietTK_VND_P2 p2 = (SoChiTietTK_VND_P2)((XRSubreport)sender).ReportSource;
        ...
        {
            SoChiTietTK_VND_P3 p3 = (SoChiTietTK_VND_P3)((XRSubreport)sender).ReportSource;
            IList<RP_SoDuTaiKhoan> lstdata = new List<RP_SoDuTaiKhoan>();
            if (m_MaTK == Vns.QuanLyDoanRa.Globals.TkTienMat || m_MaTK == Vns.QuanLyDoanRa.Globals.TkTienChuyenKhoan)
            {
