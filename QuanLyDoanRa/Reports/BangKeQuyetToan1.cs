...
{
    public partial class BangKeQuyetToan1 : DevExpress.XtraReports.UI.XtraReport
    {
        public IRP_BC04DRService RP_BC04DRService;
        public IVnsDoanCongTacService VnsDoanCongTacService;
        DataTable dt;
        public BangKeQuyetToan1()
        {
            InitializeComponent();
        }
        public BangKeQuyetToan1(DateTime p_TuNgay, DateTime p_DenNgay, String p_TkCo, String p_TkNo, string p_TrangThaiCt, string TenCt, string p_Time, int GiaTri) 
        {
            InitializeComponent();
        ...
        private void BangKeQuyetToan1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            this.DataSource = dt;
        }
        int i = 0;
