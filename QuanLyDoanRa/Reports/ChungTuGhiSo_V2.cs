...
{
    public partial class ChungTuGhiSo_V2 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public ChungTuGhiSo_V2()
        {
            InitializeComponent();
        }
        public ChungTuGhiSo_V2(DateTime p_TuNgay, DateTime p_DenNgay, string p_TkCo, string p_TkNo, string p_TrangThaiCt, int giaTri, string TimeTitle)
        {
            InitializeComponent();
        ...
        {
            ChungTuGhiSoHeader_V2 p1 = (ChungTuGhiSoHeader_V2)((XRSubreport)sender).ReportSource;
        ...
        {
            ChungTuGhiSoDetail_V2 p2 = (ChungTuGhiSoDetail_V2)((XRSubreport)sender).ReportSource;
