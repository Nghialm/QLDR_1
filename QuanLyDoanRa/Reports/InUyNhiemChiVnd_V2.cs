...
{
    public partial class InUyNhiemChiVnd_V2 : DevExpress.XtraReports.UI.XtraReport
    {
        public InUyNhiemChiVnd_V2()
        {
            InitializeComponent();
        }
        ...
        public InUyNhiemChiVnd_V2(VnsChungTu p_objChungTu, VnsDmKhachHang p_KhachHang, IList<VnsGiaoDich> p_lstGiaoDich, Decimal p_SoTien, DateTime p_NgayCt)
        {
            InitializeComponent();
